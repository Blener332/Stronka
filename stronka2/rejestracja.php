<?php
	...
	if(isset($_POST['email']))
	{
		...
		{
			$wszystko_OK=false;
			$_SESSION['blad_nick']='<span style = "color:red">Nick musi posiadać od 3 do 20 znaków!</span>';
		...
		{
			$wszystko_OK=false;
			$_SESSION['blad_nick']='<span style = "color:red">Nick może składać się tylko z liter i cyfr (bez polskich znaków)!</span>';
		}
		...
		{
			$wszystko_OK=false;
			$_SESSION['blad_email']='<span style = "color:red">Podaj poprawny adres e-mail!</span>';
		}
		...
		if($haslo1!=$haslo2){
			$wszystko_OK=false;
			$_SESSION['blad_haslo']='<span style = "color:red">Podane hasła nie są identyczne!</span>';
		}
		...
		try
		{
			...
			else
			{
				...
				{
					$wszystko_OK=false;
					$_SESSION['blad_email']='<span style = "color:red">Istnieje już konto zapisane do tego adresu e-mail!</span>';
				}
				...
				{
					$wszystko_OK=false;
					$_SESSION['blad_nick']='<span style = "color:red">Istnieje już użytkownik o takim nicku!</span>';
				}
